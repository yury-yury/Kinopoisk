...
class MovieDAO:
    ...
    def get_all_by_page(self, page: int):
        """
        The function defines the method of the class .get_all_by_page takes the page number as a parameter
    ...
    def get_all_by_page_new(self, page: int):
        ...
        its page-by-page return for further use.
        """
        return self.session.query(Movie).order_by(Movie.year.desc()).limit(LINES_PER_PAGE).offset((page - 1)
                                                                                        * LINES_PER_PAGE).all()

    def get_all(self):
        """
        The function defines the method of the class .get_all and queries all records
        of the "genre" table of the database and its return for further use.
        """
