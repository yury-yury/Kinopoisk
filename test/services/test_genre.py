...
def genre_dao():
    ...
    genre_dao.get_all_by_page = MagicMock(return_value=[genre_1, genre_2, genre_3])
...
class TestGenreService():
    ...
    def test_get_all_by_page(self):
        """
        The function contains unit tests to check the operability of the "get_all_by_page" method
        of the GenreService class.
        """
        genres = self.genre_service.get_all_by_page(1)
